...
include(":features:settings:routes")
include(":features:settings:navigation")
include(":data")
include(":data:plain_explorer")
include(":data:crypto_container_explorer")
include(":data:file_prober")
